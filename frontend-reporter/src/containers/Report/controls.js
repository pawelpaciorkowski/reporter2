                ...
                <Callout style={{ paddingTop: '0' }}>
                    <ButtonGroup style={{ marginRight: '10pt' }}>
                        <Button
                            ...
                            onClick={() => this.props.onGenerateStart(true)}
                        >
                            {this.props.definition.generate_title ? this.props.definition.generate_title : 'Generuj'}
                        </Button>
                        {!this.props.definition.hide_download ? (
                            <Button
                                intent="success"
                                icon="download"
                                disabled={this.props.working}
                                onClick={() => this.props.onGenerateStart(false, Array.from(this.props.selectedIds || []))}
                            >
                                Generuj do pobrania
                            </Button>
                        ) : null}
