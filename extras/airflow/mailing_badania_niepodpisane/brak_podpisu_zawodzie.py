...
SQL = SQL_POSTGRES = """
    ...
    from (
            ...
            WHERE
                    ...
                    and W.Zatwierdzone < (current_timestamp - interval '1 hour') and T.SYMBOL NOT IN ('K', 'KZ', 'KW')
