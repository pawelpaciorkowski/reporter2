...
dag = DAG(
    'mailing_badania_niepodpisane',
    description='Mailowa wysyłka raportów o badaniach niepodpisanych',
...
def utworz_wezel_raportu(wiersz):
    global dag
    command = "cd /home/centrum-system/airflow/dags/mailing_badania_niepodpisane ; "
    command += "export PYTHONPATH=/home/centrum-system/raporty_python_lib/ ; "
    command += "/home/centrum-system/.virtualenvs/reporter/bin/python brak_podpisu.py"
