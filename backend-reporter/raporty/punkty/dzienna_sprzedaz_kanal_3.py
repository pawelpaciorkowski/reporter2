...
datetime.date
MENU_ENTRY = "Dodatkowa sprzedaż gotówkowa - punkty pobrań 3"
...
SQL_2 = """
with t as (select 
pacjent, lab, lab_zlecenie_data, lab_gotowka, lab_znacznik_dystrybucja,platnik_zlecenia, zleceniodawca, ile_zlecen, ile_wykonan, wartosc_gotowki, kanal
...
class Groupper:
    ...
    def add_lab(self, current_date, row):
        ...
        self.add_kanal(lab, level[lab], row)
...
def dzienna_sprzedaz(task_params):
    ...
    response = result.sum_on_kanal_level()
